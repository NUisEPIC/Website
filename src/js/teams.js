(function() {
    $(function() {
        ...
        var internalTeamCircle = drawInternalTeamCircle(snap, {
            x: 300,
            y: 300
        }, 195, 260, internalTeams);
		...
		$('<div id="wildhacks-toolip" class="ui popup">WildHacks is an annual student-run intercollegiate hackathon that brings together 500+ student hackers and industry professionals for 36 hours of hacking, learning, and collaboration, sprinkled with inspiring talks and just-for-fun activities.</div>')
            .insertAfter('#wildhacks-logo');
    })
    ...
    function drawInternalTeamCircle(snap, center, rIn, rOut, teams) {
        var delta = 2 * Math.PI / teams.length;
        teams.forEach(function(team, i) {
            var teamSlice = drawInternalTeamSlice(snap, center, rIn, rOut, i * delta, delta, team);
        });
    }

    function drawInternalTeamSlice(snap, center, rIn, rOut, theta, delta, team) {
